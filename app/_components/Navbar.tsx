    ...
    <nav className="bg-[#3D1F0D] text-white sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6 text-sm font-medium">
          ...
          <Link href="/cohort-1" className="hover:text-[#F97316] transition-colors">Cohort 1</Link>
      ...
      {open && (
        <div className="md:hidden bg-[#2a1508] px-4 pb-4 flex flex-col gap-3 text-sm font-medium">
          ...
          <Link href="/cohort-1" onClick={() => setOpen(false)} className="py-2 border-b border-white/10 hover:text-[#F97316]">Cohort 1</Link>
